...
public enum OutputItem: Decodable {
    ...
    ///The results of image generation tool call.
    case imageGenerationCall(ImageGenerationToolCall)
    ...
    public init(from decoder: Decoder) throws {
        ...
        case "image_generation_call":
            let imageGenerationCall = try ImageGenerationToolCall(from: decoder)
    ...
    // MARK: - Image Generation Tool Call
    public struct ImageGenerationToolCall: Decodable {
        public let id: String
        public let type: String
        public let status: String?
        ...
        public let result: String? // Base64-encoded image string
